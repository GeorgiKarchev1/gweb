...
const plans = [
    ...
    },
    {
        ...
        features: ["всичко от бизнес", "Custom branding", "Неограничени продукти", "Мултивалута", "Custom chat bot", "14 дни безплатна поддръжка", "Изпращане на отчети всяка седмица"],
        popular: false,
    },
];
